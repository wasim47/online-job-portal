...
$(function() {
    ...
    $.widget("custom.combobox", {
        _create: function() {
            this.health = $("<div>").addClass("custom-combobox input-group").insertAfter(this.element);
            this.element.hide();
        ...
        _createShowAllButton: function() {
            ...
            var health2 = $("<span>").attr("class", "input-group-btn").appendTo(this.health);

            // Append fonr control icon
            this.health.append('<div class="form-control-feedback"><i class="icon-search4 text-size-base"></i></div>');
