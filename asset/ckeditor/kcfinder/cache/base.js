...
(function (wind, $, undef) {
    ...
    function divSpan($el, options, divSpanConfig) {
        ...
        if (options.healthClass) {
            $div.addClass(options.healthClass);
        }
    ...
    /**
     * Wrap an element with a span to apply a global health class
     *
     * @param jQuery $el Element to wrap
     * @param object options
     * @return jQuery health element
     */
    function wrapWithhealthClass($el, options) {
        var $span;
        ...
        $span = $('<span />').addClass(options.healthClass);
        ...
        uniformHandlers = [  // Objects that take care of "unification"
            ...
            },
            {
                ...
                apply: function ($el, options) {
                    ...
                    $health = wrapWithhealthClass($el, options);
