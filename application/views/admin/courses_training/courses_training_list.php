...
function approve(){
	...
	if(data=="")
	{
		...
		return false;
			...
			var hrefdata ="<?php echo base_url('admin');?>/approve?approve_val="+data+"&tablename=courses_training"+"&id=course_id"+"&status=status";
...
function deapprove(){
	...
	if(data=="")
	{
		...
		return false;
			...
			var hrefdata ="<?php echo base_url('admin');?>/deapprove?approve_val="+data+"&tablename=courses_training"+"&id=course_id"+"&status=status";
			window.location.href=hrefdata;
	}
				...
				<div class="page-header">
					...
					<div class="breadcrumb-line breadcrumb-line-component" style="margin-top:10px; margin-bottom:10px;">
						<ul class="breadcrumb" style="font-size:20px;">
							<li>Courses Training List</li>
                            <li>Total Courses Training = <?php echo $courses_training_list->num_rows();?></li>
						</ul>

		  <ul class="breadcrumb-elements">
							<div class="heading-btn-group">
								<a href="<?php echo base_url('admin/courses_training_registration');?>" class="btn btn-link btn-float has-text">
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						...
						<table class="table datatable-show-all" width="100%">
                                    ...
                                    <?php
									$i=0;
                                    foreach($courses_training_list->result() as $ctD):
									$c_id=$ctD->courses_id;
									$couTitle=$ctD->title;
									...
									?>
                                      <tr>
                                       <td><?php echo $i;?></td>
                                       <td><?php echo $couTitle; ?></td>
                                       <td><?php echo $c_duration; ?></td>
                                       <td><?php echo $app_deadline; ?></td>
                                       <td><?php echo $c_starts; ?></td>
                                       <td><?php echo $c_fee; ?></td>
										...
										<ul class="icons-list">
											<li class="dropdown">
												...
												<ul class="dropdown-menu dropdown-menu-right">
													<li><a href="<?php echo base_url('admin/courses_training_registration/'.$c_id);?>" style="color:#EDBB0E">
                                                    <i class="glyphicon glyphicon-edit"></i> Edit Information</a></li>
													<li><a href="javascript:void();" onclick="openPage1('<?php echo $c_id;?>','courses_training','courses_id');" style="color:#ff0000">
