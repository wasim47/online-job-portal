...
<?php
if($jobpostUpdate->num_rows()>0){
	foreach($jobpostUpdate->result() as $job);
	$job_id = $job->job_id;
	$emp_id = $job->emp_id;
	$job_title = $job->job_title;			
	$catType = $job->catType;
	$job_category = $job->job_category;
	$publishedBy = $job->publishedBy;
	$vacancy = $job->vacancy;
	$jobNatur = $job->jobNatur;
	...
	$allow_gender = $job->allow_gender;
	$contactAddress = $job->contactAddress;
	$applyOnline = $job->applyOnline;
	$customEmail = $job->customEmail;
	$deadline = $job->deadline;
	$cvRewceivedOption = $job->cvRewceivedOption;
	$displayComName = $job->displayComName;
	$displayComAddress = $job->displayComAddress;
	$hot_jobs = $job->hot_jobs;
			
	$menutitle='Edit Job Post';
	
	$queryCat = $this->db->query("SELECT * FROM jobtype WHERE cid='".$catType."'");
	$crow = $queryCat->row_array();
	$catname = $crow['cat_name'];
	
	$querySCat = $this->db->query("SELECT * FROM category WHERE scid='".$job_category."'");
	$scrow = $querySCat->row_array();
	$scatname = $scrow['sub_cat_name'];	
}
else{
	$job_id ='';
	$emp_id = '';
					...
					<div class="breadcrumb-line breadcrumb-line-component" style="margin-top:10px; margin-bottom:10px;">
						...
						<ul class="breadcrumb-elements">
							<div class="heading-btn-group">
								<a href="<?php echo base_url('admin/jobpost_list');?>" class="btn btn-link btn-float has-text">
                                <i class="glyphicon glyphicon-list"></i><span>Job Post List</span></a>
							</div>
						</ul>
					</div>
				</div>
                                 	  ...
                                 	  <div class="panel-group" id="accordion">
                                        <div class="panel panel-default">
                                           ...
                                           <label class="control-label col-md-3 col-sm-3 col-xs-12">Category</label>
                                            ...
                                            <div class="form-group" style="margin:0; padding:0; margin-bottom:5px;">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Educational Qualification</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <textarea name="education_qualification" class="form-control col-md-7 col-xs-12" rows="5" 
                                        ...
                                        <div class="form-group" style="margin:0; padding:0; margin-bottom:5px;">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Enclose Photograph with CV ? </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                            	<div  style="border:1px solid #ccc; padding:10px;">
                                        ...
                                        <div class="form-group" style="margin:0; padding:0; margin-bottom:5px;">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Job Publish Status</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
