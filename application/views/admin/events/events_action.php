...
if($eventsUpdate->num_rows()>0){
	...
	$details=$eventsData->events_details;
	$newstitle='Edit Events';
}
else{
	$m_id='';
	$eventsTitle=set_value('events_name');
	$details=set_value('details');
	$newstitle='Add New Events';
	}
?>
<style>
.required{
					...
					<div class="breadcrumb-line breadcrumb-line-component" style="margin-top:10px; margin-bottom:10px;">
						...
						<ul class="breadcrumb-elements">
							<div class="heading-btn-group">
								<a href="<?php echo base_url('admin/events_list');?>" class="btn btn-link btn-float has-text">
                                <i class="glyphicon glyphicon-list"></i><span>Events List</span></a>
							</div>
						</ul>
					</div>
				</div>
                                   ...
                                   <div id="registration_form">	
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                                ...
                                                placeholder='Events Name' value="<?php echo $eventsTitle; ?>"  onFocus="this.placeholder=''" 
                                                onBlur="this.placeholder='Events Name'">
