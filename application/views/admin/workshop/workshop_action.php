<?php
if($workshopUpdate->num_rows()>0){
	foreach($workshopUpdate->result() as $ctD);
	$c_id=$ctD->courses_id;
	$couTitle=$ctD->title;
					...
					<div class="breadcrumb-line breadcrumb-line-component" style="margin-top:10px; margin-bottom:10px;">
						...
						<ul class="breadcrumb-elements">
							<div class="heading-btn-group">
								<a href="<?php echo base_url('admin/workshop_list');?>" class="btn btn-link btn-float has-text">
                                <i class="glyphicon glyphicon-list"></i><span>Workshop List</span></a>
							</div>
						</ul>
					</div>
				</div>
