    ...
    <div class="row">
      <div class="col-md-8"> 
        ...
        <div class="blogWraper">
          <ul class="blogList">
          	<?php foreach($newsgallery->result() as $newsg):?>
            <li>
              <div class="row">
                <div class="col-md-2">
                  <div class="postimg"><img src="<?php echo base_url('asset/uploads/news/'.$newsg->image);?>" alt="<?php echo $newsg->news_title;?>" />
                  </div>
                </div>
                <div class="col-md-10">
                  <div class="post-header">
                    <h4><a href="<?php echo base_url("news/details/".$newsg->slug);?>"><?php echo $newsg->news_title;?></a></h4>
                  </div>
                  <p>
                  	<?php 
						$strtg = strip_tags($newsg->short_description);
						$strlen = strlen($strtg);
						if($strlen > 300){
                 ...
                 <a href="<?php echo base_url("news/details/".$newsg->slug);?>" class="readmore">Read More</a> </div>
              </div>
            </li>
            <?php endforeach;?>
