    ...
    <div class="col-md-6 col-lg-6 col-sm-12" style="margin:0; padding:0">
    	<div class="row">
        	...
        	<div class="bottom-menuJ">
                <ul>
                    ...
                    <li><a href="#">My jobstarbd <span class="arrow">&#9660;</span></a>
                    	<ul class="sub-bottommenuJ">
                            <li><a href="#">My jobstarbd</a></li>
            ...
            <div class="jobseakerFormArea">
                <div class="col-sm-9 col-sm-offset-1 searchbar">
                  <div class="form-group">
                    <input type="text" class="form-control" placeholder="Search Jobs" style="float:left; width:78%" />
    ...
    <div class="col-md-6 col-lg-6 col-sm-12" style="margin:0; padding:0">
    	<div class="row">
        	...
        	<div class="bottom-menuE">
                <ul>
                	<li><a href="#">Login</a></li>
                    <li><a href="javascript:void(0;" id="element">Registration</a></li>
                    <li><a href="#">My jobstarbd <span class="arrow">&#9660;</span></a>
                    	<ul class="sub-bottommenuE">
                            <li><a href="#">My jobstarbd</a></li>
                            <li><a href="#">My Network</a></li>
                            <li><a href="#">Notifications</a></li>
                            <li><a href="#">Messages</a></li>
            ...
            <div class="jobseakerFormArea">
                <div class="col-sm-9 col-sm-offset-1 searchbar">
                  <div class="form-group">
                    <input type="text" class="form-control" placeholder="Browse CVs" style="float:left; width:78%" />
                         ...
                         >Browse Functional Categories</h5>
                        	<ul class="row catelist">
                             <?php foreach($functionalCategory->result() as $fRow):?>
                              <li class="col-md-4 col-sm-4"><a href="#."><?php echo $fRow->sub_cat_name;?><span>(174)</span></a></li>
                              <?php endforeach;?>
                            </ul>
...
<div class="section" style="margin:0; padding:0">
  <div class="container" style="margin-top:10px; background:#fafafa">
    ...
    <div class="col-md-12 col-lg-12 col-sm-12" style="margin:0; padding:0;">
    	<div class="col-md-10 col-lg-10 col-sm-12" style="margin:0; padding:0;">
            <div class="titleTop">
              <h3 style="font-size:25px; line-height:35px; margin-top:5px;">Create Your Network of Job Seekers Employees & Employers.<br /> Be inspired & Get in touch With people in your field.</h3>
            </div>
            <div class="row">
  	...
  	<div class="col-md-6 col-lg-6 col-sm-12" style="margin:0; padding:0;">
    	<div class="topjobseekerArea" style="background:#efefef; margin-top:10px;">
            <div class="titleTop">
              ...
              <div class="col-sm-3"><a href="company-detail.html">
              	<img src="<?php echo base_url();?>assets/images/employers/emplogo1.jpg" alt="Company Name" />
              </a></div>
              <div class="col-sm-9">
              	<h2>Events Headline</h2>
                <p>
                	Aliquam vestibulum cursus felis. In iaculis iaculis sapien ac condimentum. Vestibulum congue posuere 
              ...
              <div class="row" style="background:#fff; padding:10px;border-bottom:1px dotted #ccc">
              <div class="col-sm-3"><a href="company-detail.html">
              	<img src="<?php echo base_url();?>assets/images/employers/emplogo2.jpg" alt="Company Name" />
              </a></div>
              <div class="col-sm-9">
              	<h2>Events Headline</h2>
                <p>
              ...
              <div class="row" style="background:#fff; padding:10px;border-bottom:1px dotted #ccc">
              <div class="col-sm-3"><a href="company-detail.html">
              	<img src="<?php echo base_url();?>assets/images/employers/emplogo3.jpg" alt="Company Name" />
              </a></div>
              <div class="col-sm-9">
              	<h2>Events Headline</h2>
                <p>
              ...
              <div class="row" style="background:#fff; padding:10px;border-bottom:1px dotted #ccc">
              <div class="col-sm-3"><a href="company-detail.html">
              	<img src="<?php echo base_url();?>assets/images/employers/emplogo4.jpg" alt="Company Name" />
              </a></div>
              <div class="col-sm-9">
              	<h2>Events Headline</h2>
                <p>
    ...
    <div class="col-md-6 col-lg-6 col-sm-12" style="margin:0; padding:0;">
    	<div class="topEmployerArea" style="background:#f5f5f5; margin-top:10px;">
            <div class="titleTop">
              ...
              <div class="row" style="background:#fff; padding:10px;border-bottom:1px dotted #ccc">
              <div class="col-sm-3"><a href="company-detail.html">
              	<img src="<?php echo base_url();?>assets/images/employers/emplogo5.jpg" alt="Company Name" />
              </a></div>
              <div class="col-sm-9">
              	<h2>News Headline</h2>
                <p>
              ...
              <div class="row" style="background:#fff; padding:10px;border-bottom:1px dotted #ccc">
              <div class="col-sm-3"><a href="company-detail.html">
              	<img src="<?php echo base_url();?>assets/images/employers/emplogo6.jpg" alt="Company Name" />
              </a></div>
              <div class="col-sm-9">
              	<h2>News Headline</h2>
                <p>
              ...
              <div class="row" style="background:#fff; padding:10px;border-bottom:1px dotted #ccc">
              <div class="col-sm-3"><a href="company-detail.html">
              	<img src="<?php echo base_url();?>assets/images/employers/emplogo7.jpg" alt="Company Name" />
              </a></div>
              <div class="col-sm-9">
              	<h2>News Headline</h2>
                <p>
              ...
              <div class="row" style="background:#fff; padding:10px;border-bottom:1px dotted #ccc">
              <div class="col-sm-3"><a href="company-detail.html">
              	<img src="<?php echo base_url();?>assets/images/employers/emplogo8.jpg" alt="Company Name" />
              </a></div>
              <div class="col-sm-9">
              	<h2>Events Headline</h2>
                <p>
