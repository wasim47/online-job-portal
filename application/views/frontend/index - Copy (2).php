                    	...
                    	<div class="modal-content">
                            ...
                            <div class="modal-body">
                            	...
                            	<div class="form-group">
                                	<label class="control-label col-sm-4"> Full Name <span class="require">*</span></label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                	<label class="control-label col-sm-4"> Contact<span class="require">*</span></label>
                                    <div class="col-sm-8">
                                    	<input type="text" name="contact" required  placeholder="Contact No." class="form-control inputForm" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                    	<input type="text" name="username" required placeholder="Login User Name" class="form-control inputForm" />
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                	<label class="control-label col-sm-4"> Upload Your CV</label>
                                    <div class="col-sm-8">
                                            <input type="file" name="img[]" class="file">
                                            <div class="input-group col-xs-12" style="width:80%;" >
                                              <span class="input-group-addon"><i class="glyphicon glyphicon-file"></i></span>
                                              <input type="text" class="form-control input-xs inputForm" disabled placeholder="Upload CV">
  	...
  	<div class="col-md-6 col-lg-6 col-sm-12" style="margin:0; padding:0;">
    	<div class="topjobseekerArea" style="background:#efefef; margin-top:10px;">
            ...
            <?php foreach($hevents->result() as $eventh):?>
              ...
              <div class="col-sm-9">
              	<h5 style="font-size:14px; line-height:16px; font-weight:bold;"><?php echo $eventh->events_name;?></h5>
                <p>
                	<?php 
    ...
    <div class="col-md-6 col-lg-6 col-sm-12" style="margin:0; padding:0;">
    	<div class="topEmployerArea" style="background:#f5f5f5; margin-top:10px;">
            ...
            <?php foreach($hrnews->result() as $newsh):?>
              <div class="row" style="background:#fff; padding:10px;border-bottom:1px dotted #ccc">
              <div class="col-sm-3"><a href="company-detail.html">
              	<img src="<?php echo base_url('asset/uploads/news/'.$newsh->image);?>" alt="Company Name" />
              </a></div>
              <div class="col-sm-9">
              	<h5 style="font-size:14px; line-height:16px; font-weight:bold;"><?php echo $newsh->news_title;?></h5>
                <p>
                	<?php 
